...
/* -------------------------------------------------------------------------- */
// Esta funcion se va a encargar de realizar la redirección cuando
//el formulario se complete correctamente.
...
// 4 - Cuando vaya a la página de 'usuario.html' NO se debe permitir que
// mediante el botón de "Atrás"(la flechita del navegador) el usuario vuelva a index.

function navegarPaginaExito() {
  let boton = document.querySelector("button");
  localStorage.setItem("user", JSON.stringify(estadoUsuario));
  boton.disabled = true;
  boton.innerHTML = "<p>Cargando ...</p>";
  setTimeout(function () {
