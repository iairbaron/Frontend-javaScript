...
function mostrarMensajeExito(listado) {
    ...
    if (listado.length == 0) {
        const divTemplate = document.createElement('div');
        divTemplate.setAttribute('id', 'check');
        divTemplate.style = "background:rgb(0,128,0);padding:.5em 1em;color: black;margin: .5em 0;";
        ...
        const limpiar = setTimeout(function () {
        ...
        form.appendChild(divTemplateExito)
    }
